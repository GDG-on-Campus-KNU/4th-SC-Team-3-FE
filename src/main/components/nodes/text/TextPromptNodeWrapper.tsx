...
import TextPromptNodeInput from './TextPromptNodeInput';
import { Position, Handle, type NodeProps, type Node, useReactFlow } from '@xyflow/react';

export function TextPromptNodeWrapper({
  id,
  data,
  type,
  ...
  return (
    <div className={`z-10000 flex h-[195px] w-[245px] flex-col rounded-md bg-[#FFFFFF]`}>
      <TextPromptNodeInput id={id} data={data} />
      {selectedId === id && (
...
export default memo(TextPromptNodeWrapper);
